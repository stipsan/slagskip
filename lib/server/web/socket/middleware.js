...
exports.applySocketMiddleware = undefined;
...
const applySocketMiddleware = exports.applySocketMiddleware = wsServer => {

  // @FIXME
  return wsServer;

  wsServer.addMiddleware(wsServer.MIDDLEWARE_SUBSCRIBE, function (req, next) {
