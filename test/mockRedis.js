...
const mockRedis = {
  data: {
    ...
    [`user:2`]: { id: 2, username: 'superman', online: true },
    [`user:3`]: { id: 3, username: 'batman', online: true },
    [`user:4`]: { id: 4, username: 'spiderman', online: false },
    [`user:5`]: { id: 5, username: 'lex', online: false, lastVisit: '2016-03-22T00:15:46.757Z' },
    [`user:2:invites`]: [],
    [`user:3:invites`]: [4, 5],
    [`user:4:invites`]: [],
    [`user:5:invites`]: [3],
